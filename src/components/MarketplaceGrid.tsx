      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          >
            ...
            <div className="relative z-10">
              <span className="inline-flex items-center gap-2 bg-[#facc15] text-black text-xs font-bold tracking-wider px-4 py-2.5 rounded-[9px]">
        ...
        >
          ...
          <div className="relative z-10 max-w-[45%]">
            <h3 className="text-4xl font-bold tracking-wide mb-3">
              <span className="text-[#facc15]">EBAY</span>{" "}
            ...
            <ul className="space-y-2 mb-5">
              {["Globalna dostava", "eBay Buyer Protection", "Hiljade dostupnih dijelova"].map((item) => (
                <li key={item} className="flex items-center gap-2 text-white text-sm">
                  <span className="w-5 h-5 rounded-full border border-[#facc15] flex items-center justify-center flex-shrink-0">
                    <Check className="w-3 h-3 text-[#facc15]" strokeWidth={3} />
                  </span>
                  {item}
                </li>
              ))}
