    ...
    <div className="backdrop-blur-md rounded-lg w-full max-w-2xl animate-fade-in-up shadow-2xl bg-white/0 overflow-hidden border border-white/[0.28]">
      ...
      {(() => {
        ...
        <button
          ...
          className={`relative flex flex-col items-center gap-2 py-4 px-3 text-xs font-semibold tracking-wide transition-all duration-200 after:content-[''] after:absolute after:w-full after:h-[3px] after:bottom-0 after:left-0 after:bg-brand-red after:transition-transform after:duration-300 ${
