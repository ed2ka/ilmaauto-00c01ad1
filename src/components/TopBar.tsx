...
const OlxIcon = () => (
  <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4">
    <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-1.5 14.5c-2.49 0-4.5-2.01-4.5-4.5s2.01-4.5 4.5-4.5 4.5 2.01 4.5 4.5-2.01 4.5-4.5 4.5zm7-7h-2v5h2v-5z" />
  </svg>
);
...
const TopBar = () => {
  return (
    <div className="bg-foreground text-background/70 text-xs">
      <div className="container mx-auto px-4 lg:px-8 flex items-center justify-between h-9">
        ...
        <div className="flex items-center gap-1">
          <a href="#" className="p-1.5 hover:text-background transition-colors" aria-label="OLX">
            <OlxIcon />
          </a>
          <div className="w-px h-3 bg-background/20" />
          <a href="#" className="p-1.5 hover:text-background transition-colors" aria-label="Facebook">
            <Facebook className="w-4 h-4" />
          </a>
          <div className="w-px h-3 bg-background/20" />
          <a href="#" className="p-1.5 hover:text-background transition-colors" aria-label="Instagram">
            <Instagram className="w-4 h-4" />
          </a>
          <div className="w-px h-3 bg-background/20" />
          <a href="#" className="p-1.5 hover:text-background transition-colors" aria-label="Viber">
            <ViberIcon />
          </a>
          <div className="w-px h-3 bg-background/20" />
          <a href="#" className="p-1.5 hover:text-background transition-colors" aria-label="WhatsApp">
            <WhatsAppIcon />
          </a>
        </div>
      </div>
