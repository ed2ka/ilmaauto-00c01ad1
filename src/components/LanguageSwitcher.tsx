...
const LANGUAGES: { code: LangCode; flag: string; name: string }[] = [
  { code: "BIH", flag: "/flags/ba.png", name: "Bosna i Hercegovina" },
  { code: "CRO", flag: "/flags/hr.png", name: "Hrvatska" },
  { code: "SRB", flag: "/flags/rs.png", name: "Srbija" },
...
const LanguageSwitcher = () => {
  ...
  return (
    <DropdownMenu>
      ...
      >
        <img src={active.flag} alt={active.name} className="w-5 h-[14px] object-cover rounded-[2px]" />
      ...
      <DropdownMenuContent align="end" className="min-w-[220px] z-[100]">
        {LANGUAGES.map((lang) => (
          ...
          >
            <img src={lang.flag} alt={lang.name} className="w-5 h-[14px] object-cover rounded-[2px]" />
